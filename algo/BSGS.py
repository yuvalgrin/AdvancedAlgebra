...
def baby_step_giant_step(generator: FiniteFieldElement, element: FiniteFieldElement):
    ...
    In each creation of an element, we check whether it is found in the baby_list,
    ...
    """
    validate_inputs(element, generator)
...
def validate_inputs(generator: FiniteFieldElement, element: FiniteFieldElement):
    ...
    # The input generator must be different from the unit element:
    if generator == e1:
